		...
		<div class="container">
			<div
				...
				<div class="col-lg-5  col-md-6 header-right">
					<h4 class="text-white pb-30">Login to Book ${carselected.model }</h4>
					...
					<p>I don't have an account.<a href="register.jsp">Sign Up</a></p>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row d-flex justify-content-center pb-40">
				<div class="col-md-8 pb-40 header-text">
					...
					<p class="text-center">Who are in extremely love with eco
						friendly system.</p>
				</div>
			</div>
				...
				<div class="row align-items-center single-model item">
					<div class="col-lg-6 model-left">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit,
							...
							aliqua.</p>
						<p>
							Capacity : 04 Person <br> Doors : 04 <br> Air Condition
							: Dual Zone <br> Transmission : Automatic
						</p>
						<a class="text-uppercase primary-btn" href="#">Book This Car
							Now</a>
					</div>
		...
		<div class="container">
			<div class="row d-flex justify-content-center">
				<div class="col-md-8 pb-40 header-text text-center">
					...
					<p class="mb-10 text-center">Who are in extremely love with eco
						friendly system.</p>
				</div>
			</div>
			<div class="row">
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-10">
					...
					<a class="callaction-btn text-uppercase" href="#">Reach Our
						Support Team</a>
				</div>
			</div>
		</div>
